...
void AC() {
    ...
    for(; t--; ) {
        ...
        s += count(a.begin(), a.end(), 'O')*2;
        s += count(a.begin(), a.end(), 'Y')*3;
        s += count(a.begin(), a.end(), 'G')*4;
        s += count(a.begin(), a.end(), 'B')*5;
        s += count(a.begin(), a.end(), 'I')*6;
        s += count(a.begin(), a.end(), 'V')*7;
        writeln(s);
    }
